...
//material category
$route['material_category'] = 'Administrator/Material/add_category';
$route['get_material_categories'] = 'Administrator/Material/getCategories';
$route['add_material_category'] = 'Administrator/Material/insert_category';
$route['update_material_category'] = 'Administrator/Material/update_category';
$route['delete_material_category'] = 'Administrator/Material/catdelete';
...
$route['material_list'] = 'Administrator/Material/materialList';
...
//Material Purchase
$route['material_purchase'] = 'Administrator/MaterialPurchase/materialPurchase';
$route['material_purchase/(:any)'] = 'Administrator/MaterialPurchase/materialPurchase/$1';
$route['add_material_purchase'] = 'Administrator/MaterialPurchase/addMaterialPurchase';
$route['update_material_purchase'] = 'Administrator/MaterialPurchase/updateMaterialPurchase';
$route['delete_material_purchase'] = 'Administrator/MaterialPurchase/deleteMaterialPurchase';
$route['material_purchase_record'] = 'Administrator/MaterialPurchase/MaterialPurchaseRecord';
$route['get_material_purchase'] = 'Administrator/MaterialPurchase/getMaterialPurchase';
$route['get_material_purchase_details'] = 'Administrator/MaterialPurchase/getMaterialPurchaseDetails';
$route['material_purchase_invoice/(:any)'] = 'Administrator/MaterialPurchase/materialPurchaseInvoice/$1';
//Material Sale
$route['material_sale'] = 'Administrator/MaterialSale/materialSale';
$route['material_sale/(:any)'] = 'Administrator/MaterialSale/materialSale/$1';
$route['add_material_sale'] = 'Administrator/MaterialSale/addMaterialSale';
$route['update_material_sale'] = 'Administrator/MaterialSale/updateMaterialSale';
$route['delete_material_sale'] = 'Administrator/MaterialSale/deleteMaterialSale';
$route['material_sale_record'] = 'Administrator/MaterialSale/MaterialSaleRecord';
$route['get_material_sale'] = 'Administrator/MaterialSale/getMaterialSale';
$route['get_material_sale_details'] = 'Administrator/MaterialSale/getMaterialSaleDetails';
$route['material_sale_invoice/(:any)'] = 'Administrator/MaterialSale/materialSaleInvoice/$1';
...
$route['production_record'] = 'Administrator/Production/productionRecord';
$route['production_invoice/(:any)'] = 'Administrator/Production/productionInvoice/$1';

//convert Product
$route['convertproduct'] = 'Administrator/ConvertProduct';
$route['convertproduct/edit/(:any)'] = 'Administrator/ConvertProduct/edit/$1';
$route['add_convertproduct'] = 'Administrator/ConvertProduct/addConvertProduct';
$route['update_convertproduct'] = 'Administrator/ConvertProduct/updateConvertProduct';
$route['delete_convertproduct'] = 'Administrator/ConvertProduct/deleteConvertProduct';
$route['get_convertproduct_master'] = 'Administrator/ConvertProduct/getConvertMaster';
$route['get_convertproduct_record'] = 'Administrator/ConvertProduct/getConvertProductRecord';
$route['get_convertproduct_details'] = 'Administrator/ConvertProduct/getConvertProductDetails';
$route['get_convert_products'] = 'Administrator/ConvertProduct/getConvertProducts';
$route['convertproduct_record'] = 'Administrator/ConvertProduct/convertproductRecord';
$route['convertproduct_invoice/(:any)'] = 'Administrator/ConvertProduct/convertproductInvoice/$1';
