	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-12 header" style="height: 130px;">
				<img src="<?php echo base_url(); ?>assets/images/linkup_erp_logo.jpg" style="border-radius: 5px;" class="img img-responsive center-block">
			</div>
