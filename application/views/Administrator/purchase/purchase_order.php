	...
	new Vue({
		...
		methods: {
			...
			calculateTotal() {
				...
				this.purchase.total = parseFloat(parseFloat(this.purchase.subTotal) - parseFloat(this.purchase.discount)).toFixed(2);
				this.purchase.vat = ((this.purchase.total * parseFloat(this.vatPercent)) / 100).toFixed(2);
				this.purchase.total = parseFloat(parseFloat(this.purchase.total) + parseFloat(this.purchase.vat) + parseFloat(this.purchase.freight)).toFixed(2);
