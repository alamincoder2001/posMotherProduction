    ...
    <div class="row topData">
        <div v-if="showTopData" style="display:none;" v-bind:style="{ display: showTopData ? '' : 'none' }">
            ...
            <div class="col-md-4 col-xs-12">
                ...
                <top-production type="PieChart" :data="topProductions" :options="topProductionsOptions" />
            </div>
            <div class="col-md-4 col-xs-12">
                <table class="table custom-table-bordered" style="margin: 0;margin-top:20px;">
                    ...
                    <tbody>
                        <tr v-for="customer in topCustomers">
                            <td width="75%" style="text-align: left;">{{customer.customer_name}}</td>
                            <td width="25%" style="text-align: right;">{{customer.amount}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
