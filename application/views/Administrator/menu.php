...
?>
	<ul class="nav nav-list">
		...
		<?php if ($this->session->userdata('is_production') == 'true') { ?>
			<li class="">
...
<?php } elseif ($module == 'ProductionModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("production", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/production' ? 'active' : '' ?>">
		...
		<?php endif; ?>
		<?php if (array_search("production_record", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/production_record' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>production_record">
		...
		<?php endif; ?>
		<?php if (array_search("convertproduct", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/convertproduct' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>convertproduct">
					<i class="menu-icon fa fa-exchange"></i>
					<span class="menu-text"> ConvertProduct Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("convertproduct_record", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/convertproduct_record' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>convertproduct_record">
					<i class="menu-icon fa fa-save"></i>
					<span class="menu-text" style="font-size: 12px;"> ConvertProduct Record </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("material_sale", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/material_sale' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>material_sale">
					<i class="menu-icon fa fa-shopping-cart"></i>
					<span class="menu-text"> Meterial Sale </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		<?php if (array_search("material_sale_record", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/material_sale_record' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>material_sale_record">
					<i class="menu-icon fa fa-save"></i>
		...
		<?php if (array_search("material_purchase", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/material_purchase' ? 'active' : '' ?>">
		...
		<?php if (array_search("material_purchase_record", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/material_purchase_record' ? 'active' : '' ?>">
		...
		<?php if (array_search("materials", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/materials' ? 'active' : '' ?>">
		...
		<?php if (array_search("material_damage", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/material_damage' ? 'active' : '' ?>">
		...
		<?php if (
			...
			|| array_search("material_category", $access) > -1
			|| array_search("material_list", $access) > -1
			|| array_search("material_ledger", $access) > -1
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)
		) : ?>
			<li class="<?= current_url() == '/material_stock' || current_url() == '/material_category' || current_url() == '/material_list' || current_url() == '/reorder_list' || current_url() == '/material_ledger' ? 'open' : '' ?>">
				<a href="<?php echo base_url(); ?>" class="dropdown-toggle">
					<i class="menu-icon fa fa-file"></i>
					<span class="menu-text"> Report </span>
				...
				<ul class="submenu">
					<?php if (array_search("material_stock", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/material_stock' ? 'active' : '' ?>">
					...
					<?php if (array_search("material_ledger", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/material_ledger' ? 'active' : '' ?>">
					...
					<?php if (array_search("material_list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/material_list' ? 'active' : '' ?>">
					...
					<?php if (array_search("material_category", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/material_category' ? 'active' : '' ?>">
