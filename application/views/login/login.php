				...
				<div class="company-feature">
					<div class="com-image">
						<?php if ($companyInfo->Company_Logo_thum == "") { ?>
							<img src="/assets/login/img/images.jpg" style="width: 100%;background: white; height: 80px; border-radius: 15px; margin-top: 10px; padding: 5px; border: 1px solid white;">
						<?php } else { ?>
							<img src="/<?php echo $companyInfo->Company_Logo_thum; ?>" style="width: 100%;background: white; height: 80px; border-radius: 15px; margin-top: 10px; padding: 5px; border: 1px solid white;">
						<?php } ?>
					</div>
